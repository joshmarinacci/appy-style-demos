...
urlshortener.url.insert({
    key:'AIzaSyARiC7lumkICdnQPgnpvu3yRH_UH89Go4U',
    resource: {
        longUrl: 'http://joshondesign.com/'
    }
...
var clientsecret = "OyJplw4yySkjDcplOR7POgD5";
...
function getContacts(auth) {
    ...
    /*
    var gdataClient = require('gdata-js')(auth.clientId_,
        auth.clientSecret_, 'http://localhost:8553/');
        */
    ...
    request('https://www.google.com/m8/feeds/contacts/default/full?v=3.0', function(err,res,body) {
        console.log(err);
        //console.log(res);
        console.log(body);
    });
